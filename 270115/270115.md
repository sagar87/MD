...
* Analyse NVT (constant number of particle, volume and temperature) ensemble → canonical
...
* Analyse NPT (constant number of particles, pressure and temperature) → isothermal-isobaric
